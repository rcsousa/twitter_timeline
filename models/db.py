...
auth.settings.expiration = 2592000  # seconds ( this is a month worth)
...
auth.settings.login_form = RPXAccount(request,
    api_key='63605885848591a98b7c8f2cfe179234a59d6616',
    domain='rcsousa',
    url = "http://dev-rcsousa-03.rcsousa.com.br/%s/default/user/login" % request.application)
...
db.define_table('timeline',
    ...
    Field('tweeter', 'reference auth_user'),
    Field('tweet_guid', 'text', requires=IS_NOT_EMPTY()),
    Field('created_on', 'datetime', default=request.now),
    )
